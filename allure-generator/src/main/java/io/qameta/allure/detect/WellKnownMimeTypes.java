...
/**
 * Pure-data class holding the extension → MIME-type mapping.
 * The extension map is ported from <a href="https://tika.apache.org/">tika-core:2.9.1</a>.
 *
 * @see WellKnownFileExtensionsUtils
 */
public final class WellKnownMimeTypes {

    static final Map<String, String> EXT_TO_MIME_TYPE;
