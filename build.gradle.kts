...
subprojects {
    ...
    dependencyManagement {
        imports {
            ...
            mavenBom("org.junit:junit-bom:5.13.2")
        }
        dependencies {
            ...
            dependency("com.puppycrawl.tools:checkstyle:10.25.1")
            ...
            dependency("net.sourceforge.pmd:pmd-java:7.14.0")
